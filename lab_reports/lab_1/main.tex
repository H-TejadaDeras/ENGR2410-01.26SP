...
As the input voltage increased, the branch currents scaled proportionally, improving the signal-to-noise ratio of the measurements and resulting in significantly lower error. This is consistent with the decrease in percent error from $7.6494\%$ at $0.2\,\text{V}$ to $0.3872\%$ at $1\,\text{V}$.
Overall, the decreasing percent error with increasing input voltage indicates that the R-2R ladder network behaves as expected and closely matches theoretical predictions. 
%----------------------------------------------------------
