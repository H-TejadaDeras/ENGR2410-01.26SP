...
\section{Experiment 3: Resistive Current Division}
    ...
    \begin{figure}[H]
		...
		\caption{The schematic for the setup we used in Experiment Three.}\label{fig:exp3_plot}
	\end{figure}
	\subsection{Results}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.35\linewidth]{../../lab_code/matlab/Lab1/exp3_plot.pdf}
