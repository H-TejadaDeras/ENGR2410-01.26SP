...
\section{Experiment 1: Resistance Measurement}
	...
	\begin{figure}[h]
 		\centering
   		\includegraphics[width=\linewidth]{../../lab_code/matlab/Lab1/exp1_plot.pdf}
...
\section{Experiment 2: Resistive Voltage Division}
	...
	\end{table}
	The voltage divider that was used was comprised of two resistors in series with each other, making a voltage divider ratio of $1/2$. Below is the voltage divider transfer characteristic as measured.
	\begin{figure}[H]
 		\centering
   		\includegraphics[width=0.9\linewidth]{../../lab_code/matlab/Lab1/exp2_plot.pdf}
...
\section{Experiment 4: R-2R Ladder Network}
	\begin{figure}[h]
 		\centering
   		\includegraphics[width=\linewidth]{../diagrams/lab1_exp4_diagram.pdf}
