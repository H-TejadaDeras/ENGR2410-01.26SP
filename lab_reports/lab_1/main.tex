...
\section{Experiment 1: Resistance Measurement}
    ...
    \caption{Current–voltage characteristic of the resistor measured with the SMU, with a linear fit used to extract the resistance from the SMU data.}\label{fig:exp2_plot}
    \end{figure}
